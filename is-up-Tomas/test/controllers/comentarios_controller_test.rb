...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create comentario' do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { descripcion: @comentario.descripcion, fechahora: @comentario.fechahora, local: @comentario.local, mailusuario: @comentario.mailusuario, puntaje: @comentario.puntaje } }
    end
  ...
  test 'should update comentario' do
    patch comentario_url(@comentario), params: { comentario: { descripcion: @comentario.descripcion, fechahora: @comentario.fechahora, local: @comentario.local, mailusuario: @comentario.mailusuario, puntaje: @comentario.puntaje } }
