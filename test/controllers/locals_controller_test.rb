...
class LocalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create local' do
    assert_difference('Local.count') do
      post locals_url, params: { local: { comentarios: @local.comentarios, descripcion: @local.descripcion, imagen: @local.imagen, nombre: @local.nombre, valoracion: @local.valoracion } }
    end
  ...
  test 'should update local' do
    patch local_url(@local), params: { local: { comentarios: @local.comentarios, descripcion: @local.descripcion, imagen: @local.imagen, nombre: @local.nombre, valoracion: @local.valoracion } }
