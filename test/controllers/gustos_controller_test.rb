...
class GustosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create gusto' do
    assert_difference('Gusto.count') do
      post gustos_url, params: { gusto: { descripcion: @gusto.descripcion, mail1: @gusto.mail1, mail2: @gusto.mail2 } }
    end
  ...
  test 'should update gusto' do
    patch gusto_url(@gusto), params: { gusto: { descripcion: @gusto.descripcion, mail1: @gusto.mail1, mail2: @gusto.mail2 } }
